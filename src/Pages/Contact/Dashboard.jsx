    ...
    return (
        <div>
            ...
            <div className="flex flex-col lg:flex-row">
                <div className="lg:w-1/5 min-h-[calc(100vh-60px)] bg-[#efa24b62]">
                    <ul className="menu pt-3 grid grid-cols-1 text-lg font-medium">
                        <div className="flex items-center justify-between px-5 mb-10">
                            {
                                user ?
                                    <img className="w-24 h-24 rounded-full" src={user.photoURL} alt="User-Photo" />
                                    :
                                    ''
                            }
                        ...
                        <li>
                            ...
                            >
                                <BiSolidCollection></BiSolidCollection>   To-Do List
                            </NavLink>
                        ...
                        <li>
                            ...
                            >
                                <MdManageAccounts></MdManageAccounts>  Task Management
                            </NavLink>
                        ...
                        <li>
                            ...
                            >
                                <MdCreateNewFolder></MdCreateNewFolder>   Create Task
                            </NavLink>
